...
enum EnumGlobalsBackgroundElements {
  ...
  AnimatedElementPlanetGas2(path: "background/elements/PlanetGas2.png", amount: 50, stepTime: 0.15,
      sizeimageX: 100, sizeimageY: 100),
  AnimatedElementPlanetGas3(path: "background/elements/PlanetGas3.png", amount: 50, stepTime: 0.15,
      sizeimageX: 100, sizeimageY: 100),
