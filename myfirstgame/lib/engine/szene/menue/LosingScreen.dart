...
class LosingScreen extends SpriteComponent with HasGameRef<MySpaceGame>

{
...

  {
      ...
      MyTextField textFieldueber = MyTextField(position.x + 90,position.y + 60,  "Game Over", Colors.red);
      add(textFieldueber);
      MyTextField textField = MyTextField(position.x +90, position.y + 120,  "Du hast leider \ngegen einen \nBot verloren :(", Colors.white);
      add(textField);
